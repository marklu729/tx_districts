...
## OBJECTIVE: this project will present the number and percentage of K-12 student enrollment by three ethnicity groups in the past 20 years from 1999 through 2018 school year in Texas, and build a web-based dashboard application using Dash to illustrate the interactive Choropleth Map.
